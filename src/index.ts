...
export function themeable<ThemeNames extends string, Definition extends ClassThemeDefinition<ThemeNames>>(
  theme: Definition,
  classNameDecorator?: ClassNameDecorator<string>,
): Themeable<ThemeNames>;

export function themeable<ThemeNames extends string, Definition extends StyleThemeDefinition<ThemeNames>>(
  theme: Definition,
  classNameDecorator?: ClassNameDecorator<CSSProperties>,
): Themeable<ThemeNames>;

export function themeable<ThemeNames extends string, Definition extends ThemeDefinition<ThemeNames>>(
  theme: Definition,
